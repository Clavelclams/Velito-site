...
export const metadata = {
  title: "Prévention & esport responsable — ARENA",
  description:
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12">
      ...
      <div className="space-y-8">
        <section className="rounded-lg border border-arena-border bg-arena-surface p-5">
          ...
          <p className="mt-2 text-sm leading-relaxed text-gray-300">
            ...
            et pas d&apos;écran dans l&apos;heure avant de dormir — le sommeil
            est le premier facteur de performance, en compétition comme en cours.
        ...
        <section className="rounded-lg border border-arena-border bg-arena-surface p-5">
          ...
          <p className="mt-2 text-sm leading-relaxed text-gray-300">
            ...
            cohérence avec l&apos;âge des participants — c&apos;est
            non-négociable pour nous.
          </p>
        </section>
        ...
        <section className="rounded-lg border border-arena-border bg-arena-surface p-5">
          ...
          <p className="mt-2 text-sm leading-relaxed text-gray-300">
            Pratique de jeu qui déborde, harcèlement en ligne, mal-être — il
            existe des services gratuits et anonymes en France :
          </p>
          <ul className="mt-3 space-y-2 text-sm text-gray-300">
            <li className="leading-relaxed">
              <span className="font-semibold text-white">Joueurs Info Service</span>{" "}
              — questions sur le jeu excessif, pour les joueurs et leurs proches :
              09 74 75 13 13 (appel non surtaxé).
            </li>
            <li className="leading-relaxed">
              <span className="font-semibold text-white">3018</span> — numéro
              national contre le harcèlement en ligne et les violences
              numériques (jeunes et parents).
            </li>
            <li className="leading-relaxed">
              <span className="font-semibold text-white">L&apos;équipe VEA</span>{" "}
              — sur nos événements, un membre du staff est toujours disponible
              pour en discuter, sans jugement.
            </li>
          </ul>
        </section>
      </div>
