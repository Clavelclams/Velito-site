...
export default function PageReglement() {
  return (
    <>
      ...
      <div className="space-y-6 text-sm leading-relaxed text-arena-muted">
        <section>
          <h2 className="mb-2 font-bold text-arena-ink">1. Inscriptions et check-in</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-bold text-arena-ink">2. Format et déroulement</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-bold text-arena-ink">3. Scores et validation</h2>
          <p>
            À la fin de chaque match, le résultat est annoncé au staff, qui le
            saisit puis le valide. La validation est définitive et fait avancer le
            gagnant. En cas de désaccord sur un score,{" "}
        ...
        <section>
          <h2 className="mb-2 font-bold text-arena-ink">4. Retards et forfaits</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 font-bold text-arena-ink">5. Fair-play</h2>
          <p>
            ...
            de récidive, sans remboursement des frais d&apos;inscription éventuels.
            L&apos;esprit ARENA : on joue dur, on respecte tout le monde. Les mineurs sont sous la responsabilité des encadrants
        ...
        <section>
          <h2 className="mb-2 font-bold text-arena-ink">6. Litiges</h2>
          <p>
