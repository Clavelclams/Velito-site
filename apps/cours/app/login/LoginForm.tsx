    ...
    <form onSubmit={soumettre} className="flex w-full max-w-sm flex-col gap-4">
      <label className="flex flex-col gap-1">
        ...
        <input
          ...
          className="rounded-md border border-cours-border bg-cours-surface px-3 py-2 outline-none focus:border-cours-accent"
        />
      </label>
      ...
      {erreur && (
        <p role="alert" className="text-sm text-cours-depense">
          {erreur}
        </p>
      )}
      ...
      <button
        type="submit"
        disabled={enCours}
        className="rounded-md bg-cours-accent px-4 py-2 font-medium text-white transition-colors hover:bg-cours-accent-hover disabled:opacity-50"
      >
