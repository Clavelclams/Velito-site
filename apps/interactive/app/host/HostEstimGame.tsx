  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center overflow-hidden px-6 py-10">
      ...
      <div className="relative w-full max-w-5xl">
        ...
        {/* Question */}
        <h1 className="neon-title text-center text-2xl leading-tight sm:text-4xl">
        ...
        {/* Phase REVEAL — bonne réponse + podium */}
        {showReveal && (
          <section className="mt-8">
            <div className="card-ink p-6 text-center">
              ...
              {currentQuestion.unit && (
                <p className="mt-1 text-sm text-white/60">{currentQuestion.unit}</p>
              )}
            </div>
