/**
 * Page Contact VEA — REFONTE VIOLET + ROUGE + MOTION
...
export default function ContactPage() {
  ...
  // Classes communes pour les inputs — nouveau thème violet
  const inputClass =
    "w-full bg-vea-card border border-vea-border rounded-lg px-4 py-3 text-vea-white text-sm placeholder-vea-text-dim focus:outline-none focus:border-vea-purple/50 transition-colors";
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
            ...
            <div className="lg:col-span-3">
              <ScrollReveal>
                {submitted ? (
                  <div className="bg-vea-card border border-vea-red/20 rounded-xl p-8 text-center">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button type="submit" className="w-full sm:w-auto bg-vea-red hover:bg-vea-accent-hover text-white font-semibold px-8 py-3.5 rounded-lg transition-all text-sm hover:shadow-[0_0_20px_rgba(230,57,70,0.3)]">
                      Envoyer
                    </button>
                  </form>
                )}
                ...
                <div className="card-glow p-6">
                  ...
                  <ul className="space-y-4 text-sm">
                    <li>
                      ...
                      <a href="tel:+33670364414" className="text-vea-white hover:text-vea-red transition-colors">06 70 36 44 14</a>
                    </li>
                    <li>
                      <span className="block text-vea-text-dim text-xs uppercase tracking-wider mb-1">Email</span>
                      <a href="mailto:Vea@velitoesport.com" className="text-vea-white hover:text-vea-red transition-colors">Vea@velitoesport.com</a>
                    </li>
                    <li>
              ...
              <ScrollReveal delay={0.2}>
                <div className="card-glow p-6">
                  ...
                  <ul className="space-y-3">
                    {SOCIALS.map((s) => (
                      <li key={s.name}>
                        <a href={s.href} target="_blank" rel="noopener noreferrer" className="flex items-center justify-between text-sm text-vea-text-muted hover:text-vea-red transition-colors">
                          <span>{s.name}</span>
